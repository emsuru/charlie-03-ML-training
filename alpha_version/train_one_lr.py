# --- FIRST ATTEMPT ---
# This script is the first attempt at training a Linear Regression model on the dataset.
...
print("Training Set Evaluation LR t1:")
...
joblib_file = "alpha_version/linear_regression_model_t1.pkl"
