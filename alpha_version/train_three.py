# --- REWRITE EVERYTHING IN FUNCTION ---
...
# def clean_encode(df): # commenting this method out for now (not needed, as I've decided to drop)
...
joblib_file = "saved_models/xgboost_model_2.pkl"
